...
export default function Home() {
  ...
  const s = {
    ...
    header: { padding: "20px 32px", borderBottom: `1px solid ${BORDER}`, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 },
  ...
  return (
    <div style={s.wrap}>
      <div style={s.header}>
        ...
        <div style={s.btnRow}>
          {/* Whimsical 移行のためのインポートボタン */}
          <button style={s.importBtn} onClick={() => navigate("/import")}>
            Whimsical から移行
          </button>
